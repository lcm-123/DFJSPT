...
class DfjsptMaEnv(MultiAgentEnv):
    ...
    def __init__(self, env_config):
        ...
        self.min_max_total_time_for_a_job = None
    ...
    def reset(self, seed=None, options=None):
        ...
        self.rule_makespan_for_current_instance = self.min_max_total_time_for_a_job
        ...
        # self.machine_mask = np.zeros(shape=(self.n_jobs, self.max_n_operations, self.n_machines), dtype=int)
        ...
        if self.stage == 0:
            ...
            if self.chosen_job >= self.n_jobs or self.chosen_job < 0:
                ...
                if self.schedule_done:
                    ...
                    self.reward_this_step = self.reward_this_step + 10
                for i in range(3):
